#######################################################################################
# FirstName/Surname: Pranpreeya Mengmungmee
# Student ID: 65070131
...
accessToken = "Bearer MjZjNzliM2YtZGY2Zi00Njc0LWJjMTctNWQ5NDZiOGQyOWViMWNjMzZmNDEtMjUx_P0A1_99fbe3d9-f0b9-406c-acd1-95d84a3d0361" 
...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    if message.find("/pranpreeya") == 0:
        ...
        name_len = len("/pranpreeya")
        location = message[name_len:].strip()
...
# 5. Prepare openweather Geocoding APIGetParameters..
        ...
        openweatherGeoAPIGetParameters = {
            "q": location,
            "limit": 1,
            "appid": "9ca44d3649cdc3ac29200b46103d86ab",
        }
